...
<p class="fig-caption"><em>[Potential problem solutions]</em></p>   
...
<p class="fig-caption"><em>[Sketched wireframes of solutions]</em></p>   
...
<p class="fig-caption"><em>[Solution 1 : New input field with blue border and tab]</em></p>   
...
<p class="fig-caption"><em>[Solution 2  : New input field with similar design]</em></p> 
